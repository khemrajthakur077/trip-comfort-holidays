      ...
      <div className="relative z-10 text-center space-y-8 flex flex-col items-center">
        ...
        <div className="max-w-xl space-y-4">
          ...
          <p className="text-lg md:text-xl text-slate-500 font-medium leading-relaxed">
            The page you're looking for might have been moved, deleted, or perhaps it never existed in the first place. Don't worry, we'll help you find your way back.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-6 w-full sm:w-auto">
          ...
          <Link 
            to="/packages" // Assuming you have a packages page
